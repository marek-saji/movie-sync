...
export const options = {
    ...
    since: {
        type: 'string',
        short: 's',
        description: 'Fetch view logs only from given date. See <https://github.com/nrkno/simple-date-parse> for syntax.',
    ...
    'trakt-client-id': {
        type: 'string',
        description: 'Go to https://trakt.tv/oauth/applications/ and create an app. Use "urn:ietf:wg:oauth:2.0:oob" for "Redirect URI" and grant "checkin" and "scrobble" permissions.',
    },
    'trakt-client-secret': {
        type: 'string',
...
export function printHelp ()
{
    ...
    process.stdout.write(`You can use the same (long) option names to set options in JSON config file: ${configFilePath}. Arguments that can be specified multiple times must be specified as arrays.\n`);
